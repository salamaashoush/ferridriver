...
| [File upload and download](/recipes/file-upload-download) | `setInputFiles`, capturing downloads with `waitForDownload` |
| [Cookies and storage](/recipes/cookies-and-storage) | `addCookies`, `storageState`, per-context overrides |
| [Multiple tabs and windows](/recipes/multiple-tabs) | `expect_page`, popup handling, switching active tab |
