...
impl Inspector {
  ...
  fn with_depth(self, max_depth: usize) -> Self {
    Self { max_depth, ..self }
  }
  ...
  fn paint(self, out: &mut String, code: &str, text: &str) {
  ...
  fn punct(out: &mut String, text: &str) {
    out.push_str(text);
  }
  ...
  fn printf(self, out: &mut String, fmt: &str, args: &[Value<'_>]) -> rquickjs::Result<usize> {
  ...
  fn args(self, out: &mut String, args: &[Value<'_>]) -> rquickjs::Result<()> {
  ...
  fn value(self, out: &mut String, value: &Value<'_>, depth: usize) -> rquickjs::Result<()> {
    use rquickjs::Type;
  ...
  /// the real globals.
  fn special_object(self, out: &mut String, object: &Object<'_>, depth: usize) -> rquickjs::Result<bool> {
