...
// Shared JS shims. Generated by `crates/ferridriver/build.rs::generate_shared_js_header`
// from `crates/ferridriver-webkit-wire/shared_js/*.js` — the SAME source the
// Linux host reads via `include_str!`. Single source of truth: edit a .js file,
// both hosts rebuild against the new bytes.
#include "ferridriver_shared_js.h"
...
static NSString *const g_ax_tree_js = FD_JS_AX_TREE;
...
static void dispatch_frame(uint32_t req_id, uint8_t op,
    ...
    switch (op) {
        case OP_CREATE_VIEW: {
            ...
            // Console capture
            NSString *const consoleJS = FD_JS_CONSOLE;
            ...
            NSString *const errorJS = FD_JS_ERROR;
            [config.userContentController addUserScript:[[WKUserScript alloc]
            ...
            NSString *const dialogJS = FD_JS_DIALOG;
            [config.userContentController addUserScript:[[WKUserScript alloc]
            ...
            NSString *const networkJS = FD_JS_NETWORK;
            [config.userContentController addUserScript:[[WKUserScript alloc]
        ...
        case OP_EVALUATE: {
            ...
            NSString *const body = FD_JS_EVAL_BODY;
        ...
        case OP_RELEASE_REF: {
            ...
            uint32_t captured_rid = req_id;
            NSString *const body = FD_JS_RELEASE_REF;
