...
/// A throwing `transform` must reject the pending write AND leave no
/// live objects at runtime teardown (a surviving reference trips
/// QuickJS's `JS_FreeRuntime` assertion).
#[tokio::test]
